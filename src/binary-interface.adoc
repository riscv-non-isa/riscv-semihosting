...
specify the semihosting specification cite:[ARMSemihostingRef]. Other shift
values of the `Entry NOP` and `Exit NOP` instructions are available for
custom use by RISC-V platforms.
